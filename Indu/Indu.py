...
banner = colored ('''		
  __
 /  |------------------$$$_IT__FINAL__YEAR__PROJECT_____$$$
|   |                                                     |
|   |                                                     |
|   |                 INDRO-SEKHAR-TRIDEEP                |                             
|   |                                                     |
|   |                                                     |
\___|_____________________________________________________|                                                     |

                                                        ''' , 'cyan')
name = colored ('''         SCRIPT Coded By === INDRANIL-SEKHAR-TRIDEEP''' , 'cyan')
...
if __name__ == "__main__":
	...
	while  1:
		print ""
		option=raw_input('INDRO-SEKHAR-TRIDEEP> ') 
		if option in options:
			...
			if option=="help":
				...
				print ""
				target = str(raw_input('Define your target> '))
				print ""
				...
				print ""
				print colored ("[-] Oh!SORRY!, '%s' is not an 0ption :( Check 'help'" , 'red' , attrs=['bold'])%option
				print ""
				continue 	
